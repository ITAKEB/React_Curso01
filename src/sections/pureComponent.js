...
/* el pureComponent hace una compación entre
las props y el state de estas para realizar un 
nuevo renderizado en el caso que sea necesario.

Esta clase de componente hace un tipo diferente de
shoulComponenUpdate, en este caso
el PureComponent se encarga de hacer la compración solio
y no necesitamos preocuparnos de ello.

En algunos casos el PureComponent devuelve falsos 
positivos, así que es mejor utilizarlo cuando
estamos haciendo uso de props simples
Es recomendable utilzarlo siempre que padamos
...
class AnimalButtoms extends PureComponent {
    state={animals:"panda"}
